...
export const birthdayDatabase: Record<string, BirthdayEntry> = {
  ...
  "02-23": {
    title: "투명한 진심",
    event: "피노키오의 날",
    meaning: "솔직한 자아가 진정한 빛을 만든다는 메시지를 담은 날입니다.",
    colorCode: "#F4A460",
    vibe: 90,
    flowerName: "살구꽃",
    flowerMeaning: "꽃말은 아가씨의 수줍음입니다. 부드럽게 당신 곁에 필요한 에너지를 선사합니다.",
    flowerImage: "/images/0223_flower.png",
    birthstoneName: "루비",
    birthstoneDesc: "열정적인 사랑과 용기를 상징합니다. 오늘 하루 당신에게 담대한 마음을 선사합니다.",
    birthstoneImage: "/images/0223_stone.png",
    birthstonePreserveColor: true,
    zodiacName: "물고기자리",
    zodiacDetail: "공감과 직관",
    zodiacImage: "/images/pisces.png",
    fortune:
      "오늘은 물고기자리의 감수성이 한층 깊어지는 날입니다. 주변의 미묘한 감정과 분위기를 읽는 능력이 높아져, 말하지 않아도 상대가 무엇을 원하는지 느끼는 순간이 많을 수 있습니다. 그 예리한 직관을 믿어 보시고, 대인관계에서는 먼저 따뜻한 말 한마디를 건네 보시기 바랍니다. 오늘 만나는 사람과의 대화에서 진심이 잘 전해질 수 있으니, 꾸밈없이 당신의 생각을 나누어 보세요. 감정의 흐름이 빠른 하루일 수 있어, 중요한 결정은 차분한 타이밍에 하시는 것이 좋습니다. 물고기자리에게 오늘은 사랑과 우정이 풍성하게 피어나는 날이 될 수 있습니다.",
    colorNameKo: "APRICOT",
    energyEmoji: "✦",
    energyDesc: "솔직한 말 한마디가 오늘의 가장 큰 행운이 됩니다. 마음을 열어 보세요.",
    anniversaryName: "피노키오의 날",
    anniversaryMain: "진실한 마음을 통해 진짜 소년이 되었던 피노키오처럼, 솔직한 자아가 우리를 빛나게 합니다.",
    anniversaryDesc: "세상이 원하는 모습이 아닌, 가장 나다운 솔직함이 우리를 진정으로 빛나게 합니다. 억지로 꾸며내지 않아도 당신 그 자체로 충분히 소중하다는 축복을 전합니다.",
  },
  "02-24": {
    title: "당당한 소신",
    event: "나는 고수가 싫어의 날",
    meaning: "남들이 다 좋다고 해도 당당하게 자신의 취향을 말할 수 있는 소신의 가치를 담은 날입니다.",
    colorCode: "#F5F5F5",
    vibe: 91,
    flowerName: "빙카 (Periwinkle)",
    flowerMeaning: "꽃말은 즐거운 추억입니다. 오늘 당신이 만들어 갈 행복한 순간들을 응원합니다.",
    flowerImage: "/images/0224_flower.png",
    birthstoneName: "화이트 크리소베릴 (White Chrysoberyl)",
    birthstoneDesc: "아름다운 눈동자라는 의미를 담고 있습니다. 본질을 꿰뚫어 보는 오늘의 기운이 당신 곁에 있습니다.",
    birthstoneImage: "/images/0224_stone.png",
    birthstonePreserveColor: true,
    zodiacName: "물고기자리",
    zodiacDetail: "공감과 직관",
    zodiacImage: "/images/pisces.png",
    fortune:
      "오늘은 물고기자리의 풍부한 상상력이 잘 드러나는 날입니다. 머릿속에서 펼쳐지는 이야기나 아이디어가 주변과 자연스럽게 조화를 이룰 수 있으니, 생각이 스치면 메모해 두거나 가까운 이와 나누어 보시기 바랍니다. 주변과 어울리면서도 나만의 감각을 잃지 않는 직관이 있어, 무리에 맞추기보다는 당신다운 선택이 오늘의 행운을 부를 수 있습니다. 대인관계에서는 부드러운 말 한마디가 큰 힘이 됩니다. 오늘 만나는 사람과의 대화에서 서로의 마음이 잘 통하는 느낌을 받으실 수 있으니, 편하게 당신의 생각을 열어 보세요. 물고기자리에게 오늘은 상상력과 직관, 그리고 따뜻한 인연이 함께 빛나는 하루가 될 수 있습니다.",
    colorNameKo: "PURE WHITE",
    energyEmoji: "✦",
    energyDesc: "당신만의 기준을 지키는 순간이 오늘의 가장 큰 행운입니다. 소신 있게 나아가 보세요.",
    anniversaryName: "나는 고수가 싫어의 날",
    anniversaryMain: "남들이 다 좋다고 해도 당당하게 자신의 취향을 말할 수 있는 소신이 빛나는 날입니다.",
    anniversaryDesc: "타인의 기준이나 세상의 시선에 맞추기보다, 본인만의 확고한 주관을 가지고 인생을 주도적으로 펼쳐 나가는 당신의 멋진 삶을 응원합니다.",
  },
  "02-12": {
    title: "포용과 보호의 기운",
    event: "포옹의 날",
